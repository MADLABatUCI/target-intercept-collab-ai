...
function runAIPlanner( objects, player , observableRadius , center, whAgent, stabilityThreshold, prevBestSol, prevAllSol, frame, alpha  ) {
    ...
    let firstStep = { x: bestSol.interceptLocations[0][0] , 
                      ...
                      ID: bestSol.ID,  // SK1 --> bestSol.ID
                    //   ID: bestSol.firstStepID, // SK1
                    //   steps: bestSol.steps, // SK1
...
//                         bestSol.steps = bestSol.interceptionOrder.length // SK1
//                         // SK1 Added a condtion taht tells you the order of the plan
//                         bestSol.firstStepID = interceptionOrder[0];      // SK1
//                         if (bestSol.steps == 3){ 
//                             // bestSol.firstStepID = interceptionOrder[0];
//                             bestSol.secondStepID = interceptionOrder[1];
//                             bestSol.thirdStepID = interceptionOrder[2];
//                         }
//                     }
