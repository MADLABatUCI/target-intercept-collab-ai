...
// MS7
function runAIPlanner( objects, player , observableRadius , center, whAgent, stabilityThreshold, prevBestSol, prevAllSol, frame  ) {
    ...
    [ bestSol, allSol ] = planSingleFrame(playerStartX, playerStartY, playerSpeed, objectPositionsX, objectPositionsY, 
        objectVelocitiesX, objectVelocitiesY, objectValues, circleRadius, ID);
    ...
    if ((stabilityThreshold != null) && (prevAllSol != null)) {
        ...
        if (currentBestID != lastBestID) {
            ...
            if (idx != -1) {
                ...
                if ((ratioScores < stabilityThreshold) && (valuePreviousPlan != -Infinity)) {
...
// MS7
function planSingleFrame(playerStartX, playerStartY, playerSpeed, objectPositionsX, objectPositionsY, objectVelocitiesX, objectVelocitiesY, objectValues, circleRadius, ID) {
    ...
    let allSol = {
        overallMaxValue: -Infinity,
        maxValue: new Array(numObjects).fill( -Infinity ),   
